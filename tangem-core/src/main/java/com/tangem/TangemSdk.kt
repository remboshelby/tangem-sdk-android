...
class TangemSdk(
     ...
     * @param walletConfig: Configuration for wallet that should be created (blockchain name, token...).
     * @param walletIndexPointer: Pointer to index at which wallet should be created.
     * If not specified - wallet will be created at default index.
     * @param cardId CID, Unique Tangem card ID number.
     * @param initialMessage: A custom description that shows at the beginning of the NFC session.
     * If null, default message will be used.
